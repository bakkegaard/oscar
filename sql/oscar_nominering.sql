...
--
-- Table structure for table `nominering`
--
...
--
-- Dumping data for table `nominering`
--

LOCK TABLES `nominering` WRITE;
/*!40000 ALTER TABLE `nominering` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `nominering` ENABLE KEYS */;
UNLOCK TABLES;
